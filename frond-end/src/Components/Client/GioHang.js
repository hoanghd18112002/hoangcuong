                            ...
                            <tbody>
                                ...
                                {items.map(gh => (
                                    <tr>
                                        ...
                                        <td>
                                            <p className="mb-0 mt-4">{gh.DonGia} VNĐ</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p className="mb-0 mt-4">{gh.DonGia * gh.SoLuong} VNĐ</p>
                                        </td>
                                        <td>
                            ...
                            <div className="bg-light rounded p-4">
                                ...
                                <div className="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                    <div style={{ display: 'inline-block' }}>
                                        <h5 className="mb-0" style={{ display: 'inline-block', marginBottom: 0 }}>Total : </h5>
                                        <p className="mb-0" style={{ display: 'inline-block', marginBottom: 0 }}>{totalPrice} VNĐ</p>
                                    </div>
                                    <button onClick={handleThanhToan} className="btn btn-secondary rounded-pill px-4 py-3 text-primary text-uppercase ms-4" type="button">Proceed to Checkout</button>
                                </div>
                            </div>
                        </div>
                    </div>
